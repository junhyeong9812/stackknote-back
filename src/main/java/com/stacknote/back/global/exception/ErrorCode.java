...
public enum ErrorCode {
    ...
    INVALID_INPUT(HttpStatus.BAD_REQUEST, "COMMON_002", "입력값이 올바르지 않습니다."), // 추가
    ...
    // 새로 추가된 인증 에러 코드들
    INVALID_CREDENTIALS(HttpStatus.UNAUTHORIZED, "AUTH_006", "이메일 또는 비밀번호가 올바르지 않습니다."),
    AUTHENTICATION_FAILED(HttpStatus.UNAUTHORIZED, "AUTH_007", "인증에 실패했습니다."),
    ACCOUNT_DISABLED(HttpStatus.UNAUTHORIZED, "AUTH_008", "비활성화된 계정입니다."),
    ACCOUNT_LOCKED(HttpStatus.UNAUTHORIZED, "AUTH_009", "잠긴 계정입니다."),
    TOKEN_REFRESH_FAILED(HttpStatus.UNAUTHORIZED, "AUTH_010", "토큰 갱신에 실패했습니다."),
    TOKEN_GENERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "AUTH_011", "토큰 생성에 실패했습니다."),
    AUTHENTICATION_PROCESSING_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "AUTH_012", "인증 처리 중 오류가 발생했습니다."),
    INVALID_LOGIN_REQUEST(HttpStatus.BAD_REQUEST, "AUTH_013", "잘못된 로그인 요청입니다."),
    MISSING_REFRESH_TOKEN(HttpStatus.BAD_REQUEST, "AUTH_014", "리프레시 토큰이 없습니다."),
